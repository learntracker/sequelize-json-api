...
var Router = module.exports = function(sequelize, transport, options) {
  ...
  api.initialize = function (){
    ...
    api.route('/:resource')
      ...
      .get(function(req, res) {
        req.locals.model
          .findAll({include: req.locals.model.includes_id})
    ...
    api.route('/:resource/:id')
      ...
      .get(function(req, res) {
        if(req.params.id.indexOf(',') > 0){
          ...
          req.locals.model
            .find({where: {id: req.params.id}, include: req.locals.model.includes_id})
            .success(function(instance){
              if(instance){
                var values = transport.serializeOne(req,instance);
                ret = {}
      ...
      .put(function(req, res) {
        req.locals.model
          ...
          .success(function(instance){
            if(instance){
              instance
                .updateAttributes(transport.deserialize(req))
                .success(function(instance) {
